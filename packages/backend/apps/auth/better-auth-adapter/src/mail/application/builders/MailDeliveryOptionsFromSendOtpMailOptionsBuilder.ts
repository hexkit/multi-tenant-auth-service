import { type Builder } from '@hexkit/patterns';
import {
  type Environment,
  EnvironmentService,
} from '@multi-tenant-auth-service/auth-env';
import { type MailDeliveryOptions } from '@multi-tenant-auth-service/mail-application';
...
@injectable()
export class MailDeliveryOptionsFromSendOtpMailOptionsBuilder implements Builder<
  MailDeliveryOptions,
  [SendOtpMailOptions]
> {
  ...
  constructor(
    ...
    this.#sourceMailAddress = environment.mail.defaultAddress;
  }
